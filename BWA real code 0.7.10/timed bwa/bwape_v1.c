...
int align_counter=0;
clock_t tic,toc;
float time_for_bwa_cal_pac_pos_pe=0,time_for_sw=0,time_for_cal_pac_pos_pe_second_block=0;
...
toc=clock();
		...
		last_ii = ii;
fprintf(stderr, "time after bwa_cal_pac_pos_pe: %.2f sec\n", (float)(clock() - toc) / CLOCKS_PER_SEC);
